...
$("#Quiz1").on("click", function(){//rozpoczyna pierwszy quiz
	...
	$("p").html(pytania[i]); //ustala pytanie na numerze indeksu tablicy 0 czyli pytanie 1
...
$("#next").on("click", function(){
	if(numerPytania!=(liczbaPytan-1)) { //powtarza wyświetlanie pytania aż do pytania 9
		$(this).attr("disabled","disabled"); //blokuje ten przycisk
		i++;      //zwiększa indeks
		...
		$("#questionNumber").html(numerPytania);
		$("#end").show().attr("disabled","disabled"); //pokazuje przycisk koniec
